...
public class MusicBox {
  ...
  private void setUpGUI() {
    ...
    JButton overFlow = new JButton("Select All");
    overFlow.addActionListener(new overFlowActionListener());
    buttonBox.add(overFlow);
  ...
  public class upTempoActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      showTempo.setText(sequencer.getTempoInBPM() + "");
    }
  }
  ...
  public class overFlowActionListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
      overFlowList();
    }
